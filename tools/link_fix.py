...
def vertaal_pad(target, src_taal, clusters, bestand_set):
    ...
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    # Fallback-regels 5-9 zijn BEWUST VERWIJDERD.
    #
    # Deze regels vertaalden broken links AUTOMATISCH naar /nl/ als de
    # anderstalige versie niet bestond. Dat werkte voor onvertaalde artikelen,
    # maar veroorzaakte 274 onterechte NL-verwijzingen: pagina's die WEL een
    # lokale vertaling hadden werden alsnog naar NL gestuurd omdat de fix
    # sneller was dan de precieze slug-vertaling die de cluster-lookup deed.
    #
    # Als je nieuwe kruistaal-vertalingen wilt registreren, voeg ze toe aan
    # slug_clusters.json onder 'wat_opkomt_clusters' of 'top_level_articles'.
    # De regels 1-4 hierboven verwerken die dan correct.
    #
    # Als een link naar een niet-vertaald artikel toch gerapporteerd moet
    # worden als 'ok' (bv. wanneer de fallback naar NL bewust gewenst is),
    # voeg de slug toe aan 'known_unpublished_slugs' in slug_clusters.json.
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
