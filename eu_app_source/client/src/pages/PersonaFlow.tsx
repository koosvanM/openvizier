...
const KLEUR_NAAM_HEX: Record<string, string> = {
  // NL-namen (V4-basisset)
  rood: '#ef4444', donkerrood: '#b00000',
  groen: '#22c55e', smaragd: '#10b981', donkergroen: '#16a34a',
  blauw: '#3399FF', donkerblauw: '#0054A5', turkoois: '#14b8a6',
  oranje: '#f97316', geel: '#eab308', goud: '#FFD700',
  paars: '#3F2A56', kastanje: '#c2410c',
  zwart: '#1B1B1B', grijs: '#999999',
  // v0.1 — EU/Brussel partij-eigen kleuren (fractie-officieel zoals gepresenteerd in EP-visualisaties)
  // EPP=blauw, S&D=rood, Renew=goud, Greens/EFA=groen, ECR=donkerblauw,
  // PfE=paars, The Left=donkerrood, ESN=zwart, NI=grijs
  // VMP=gris (goud accent), CARB=verde marino (klimaat-groen)
